...
def to_lal_coords(m1, m2, chi1, kappa, thetaJ, psiJ, alpha0, f_inj):
    ...
    spin = np.array(shat) 		# Returns Shat, not spin.
...
class waveform:
	def __init__(self, f_inj, f_max, delta_f, amplitude_order=0, phase_order=7, spin_order=5, approximant='SpinTaylorF2', sideband=None, **kwargs):
		self._finj = f_inj
